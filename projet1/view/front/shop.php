    ...
    $(function(){
        ...
        setInterval(function(){
            ...
            $.get("code_panier.php",{operation:"compter"},function(data){
                ...
                $.get("code_panier.php?operation=lire",function(datas){
                    ...
                    $("prix").text(parseInt($("prix").text())+parseInt(value[2]));
                    })  
        ...
        setInterval(function(){
                ...
                $.get("code_panier.php",{operation:"supprimer",id:$(this).attr("id")})
                var n=parseInt($("prix").text());
                $(".shopping-cart-items li[id='"+$(this).attr("id")+"']").remove();
                var n1=parseInt($(this).attr("prix"));
                var t=n-n1;
                if(t>=0){
                $("prix").text(t);   
                }
