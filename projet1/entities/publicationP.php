...
function getBillet($idBillet) {
	...
	function modifierPublication($Publication,$des){
		$sql="UPDATE publication SET  titre=:titre,categorie=:categorie,date_debut=:date_debut,date_fin=:date_fin WHERE desc=:desc";
